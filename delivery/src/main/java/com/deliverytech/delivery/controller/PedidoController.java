...
public class PedidoController {
    ...
    public ResponseEntity<PagedResponseWrapper<PedidoResponseDTO>> listar(
            ...
            @Parameter(description = "Data inicial") @RequestParam(required = false)
            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dataInicio,
            @Parameter(description = "Data final") @RequestParam(required = false)
    ...
    public ResponseEntity<ApiResponseWrapper<PedidoResponseDTO>> atualizarStatus(
        ...
        StatusPedido status;
        try {
            status = StatusPedido.valueOf(statusDTO.getStatus());
        } catch (IllegalArgumentException ex) {
            return ResponseEntity.badRequest()
                    .body(ApiResponseWrapper.error("Status inválido"));
        }
    ...
    public ResponseEntity<ApiResponseWrapper<CalculoPedidoResponseDTO>> calcularTotal(
        ...
        CalculoPedidoResponseDTO calculo = new CalculoPedidoResponseDTO(
                pedidoService.calcularTotalPedido(dto.getItens())
        );
